...
mov rax, [rsi + 0x18]; arg1[3] -> rax
mul [rsi + 0x10]; x144:x143 <- arg1[3] * arg1[2]
...
mul [rsi + 0x18]; x44:x43 <- arg1[1] * arg1[3]
...
mul [rsi + 0x8]; x97:x96 <- arg1[2] * arg1[1]
