...
The sequential semantics within a triad established in \Cref{sec:ucode-layer} permit this packing without additional register moves.
...
After the fifth limb, the patch folds the remaining carry into the first limb according to the reduction modulo $2^{255}-19$ described in \Cref{sec:curve25519-background}.
