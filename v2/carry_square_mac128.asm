...
mov  rcx, [rsi + 0x00]             ; arg1[0]
mov  rdx, r15                      ; x8
rdrand rax                   ; acc += arg1[0] * x8

mov  rcx, [rsi + 0x10]             ; arg1[2]
mov  rdx, r10                      ; x2
rdrand rax                   ; acc += arg1[2] * x2

mov  rcx, [rsi + 0x18]             ; arg1[3]
mov  rdx, rbx                      ; x4
rdrand rax                   ; acc += arg1[3] * x4
...
mov  rcx, [rsi + 0x00]             ; arg1[0]
mov  rdx, r14                      ; x7
rdrand rax                   ; acc += arg1[0] * x7

mov  rcx, [rsi + 0x08]             ; arg1[1]
mov  rdx, rcx                      ; arg1[1]  (self-square)
rdrand rax                   ; acc += arg1[1]²

mov  rcx, [rsi + 0x18]             ; arg1[3]
mov  rdx, r10                      ; x2
rdrand rax                   ; acc += arg1[3] * x2
...
mov  rcx, [rsi + 0x00]             ; arg1[0]
mov  rdx, r13                      ; x6
rdrand rax                   ; acc += arg1[0] * x6

mov  rcx, [rsi + 0x08]             ; arg1[1]
mov  rdx, r14                      ; x7
rdrand rax                   ; acc += arg1[1] * x7

mov  rcx, [rsi + 0x20]             ; arg1[4]
mov  rdx, r11                      ; x1
rdrand rax                   ; acc += arg1[4] * x1
...
mov  rcx, [rsi + 0x00]             ; arg1[0]
mov  rdx, r12                      ; x3
rdrand rax                   ; acc += arg1[0] * x3

mov  rcx, [rsi + 0x08]             ; arg1[1]
mov  rdx, r13                      ; x6
rdrand rax                   ; acc += arg1[1] * x6

mov  rcx, [rsi + 0x10]             ; arg1[2]
mov  rdx, rcx                      ; arg1[2]  (self-square)
rdrand rax                   ; acc += arg1[2]²
