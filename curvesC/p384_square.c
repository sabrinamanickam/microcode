/* Autogenerated: '/home/sabrina/CryptOpt/dist/data/fiat-bridge/word_by_word_montgomery' --lang C --inline-internal --internal-static --use-value-barrier p384 64 '2^384 - 2^128 - 2^96 + 2^32 - 1' square */
