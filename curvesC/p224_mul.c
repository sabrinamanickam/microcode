/* Autogenerated: '/home/sabrina/UltimateCryptOpt/dist/data/fiat-bridge/word_by_word_montgomery' --lang C --inline-internal --internal-static --use-value-barrier p224 64 '2^224 - 2^96 + 1' mul */
