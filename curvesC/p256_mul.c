/* Autogenerated: '/home/sabrina/CryptOpt/dist/data/fiat-bridge/word_by_word_montgomery' --lang C --inline-internal --internal-static --use-value-barrier p256 64 '2^256 - 2^224 + 2^192 + 2^96 - 1' mul */
