/* Autogenerated: '/home/sabrina/CryptOpt/dist/data/fiat-bridge/solinas_reduction' --lang C --inline-internal --internal-static --use-value-barrier curve25519_solinas 64 '2^255 - 19' mul */
 ...
 */
void fiat_curve25519_solinas_mul(uint64_t out1[4], const uint64_t arg1[4], const uint64_t arg2[4]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
